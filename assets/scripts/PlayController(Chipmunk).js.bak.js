...
cc.Class({
    ...
    initPhysics: function() {
        ...
        this._space.addCollisionHandler(COLLISION_COLLECT,COLLISION_BALL,this.onCollectBegin,null,null,null);
        ...
        this._space.addCollisionHandler(COLLISION_ROLLOVER,COLLISION_BALL,this.onRolloverBegin,null,null,null);
        ...
        this._space.addCollisionHandler(COLLISION_BLOCK,COLLISION_BALL,null,null,null,this.pingSound);
    ...
    onCollectBegin: function(arbiter, space) {
